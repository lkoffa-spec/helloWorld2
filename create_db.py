...
with app.app_context():
    ...
    users = [
        ...
        {'username': 'lkoffa', 'email': 'lkoffa@terpmail.umd.edu', 'first_name':'Le-Nair', 'last_name':'Koffa',
            'password': generate_password_hash('lkoffa', method='pbkdf2:sha256'), 'role':'STUDENT'}
    ]
    ...
    students = [
        ...
        {'first_name': 'Le-Nair', 'last_name': 'Koffa', 'email':'lkoffa@terpmail.umd.edu',
            'major_id': 2, 'birth_date': dt.strptime('2001-05-15', '%Y-%m-%d'), 'is_honors': 0}
    ]
