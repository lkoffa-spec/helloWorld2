...
from instance.models import Student, Major
...
with app.app_context():
    ...
    for each_student in students:
        ...
        a_student = Student(first_name=each_student["first_name"],
                            ...
                            email=each_student["email"])   # ← ADDED
