...
class Student(db.Model):
    ...
    email = db.Column(db.String(100), nullable=False)  # ← ADDED

    def __init__(self, first_name, last_name, major_id, birth_date, is_honors, email):  # ← ADDED email
